...
- Class Time & Location
  ...
  If so, we will use meeting information provided by email and in <CourseInformationLink linkName='linkCanvas' anchorText='Canvas' />.
...
- 45%: Project
  ...
  Proposals or milestones that less than candid and thoughtful (e.g., vague, incomplete, oversold)
...
Recorded sessions will be made available for asynchronous review within <CourseInformationLink linkName='linkCanvas' anchorText='Canvas' />.
Although recordings are obviously an incomplete proxy for a discussion-focused course,
but we understand they may sometimes be the best available option relative to our wellness and safety goal.
